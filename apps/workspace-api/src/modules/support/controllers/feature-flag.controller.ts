...
export class FeatureFlagController {
  static async create(req: Request, res: Response, next: NextFunction) {
    try {
      const flag = await FeatureFlagService.createFlag(req.user!.activeOrgId, req.user!.userId, req.body);
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    try {
      const flag = await FeatureFlagService.updateFlag(req.params.id, req.user!.activeOrgId, req.user!.userId, req.body);
  ...
  static async delete(req: Request, res: Response, next: NextFunction) {
    try {
      await FeatureFlagService.deleteFlag(req.params.id, req.user!.activeOrgId, req.user!.userId);
